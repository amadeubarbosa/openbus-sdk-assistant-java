...
É possível se obter uma instância da chave privada (\emph{RSAPrivateKey}) através da classe utilitária \emph{tecgraf.openbus.security.Cryptography}, que contém métodos para se obter uma chave privada através de uma sequência de \emph{bytes} ou de um arquivo.
